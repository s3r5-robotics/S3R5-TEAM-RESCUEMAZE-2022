...
// Buttons
#define WhiteButton 35 // start/stop button
#define BlackButton 32 // other button
...
#define DriveModePin 25 // switch withc driving mode to use
...
#define BlackLow 4020
#define BlackHigh 4070
#define WhiteLow 2730
#define WhiteHigh 2770

// temperature range
#define TempLow 33 // 28
#define TempHigh 40 // 40
